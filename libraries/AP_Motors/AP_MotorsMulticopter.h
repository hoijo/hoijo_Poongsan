...
#define SIGN_PARAMETER3_DEFAULT  -0.5f
#define SIGN_PARAMETER4_DEFAULT  0.866f
#define SIGN_PARAMETER5_DEFAULT  -0.5f
...
protected:
    ...
    float               _spincoax_servo2_sign_paremter1_up_ratio;      // throttle percentage (0 ~ 1) between zero and throttle_min
