...
CXX_TGT_F = ['-c', '-o']
DEBUG = False
DEFINES = ['SKETCHBOOK="/home/pc/hoijo_Poongsan"', 'CONFIG_HAL_BOARD=HAL_BOARD_PX4', 'HAVE_OCLOEXEC=0', 'HAVE_STD_NULLPTR_T=0', 'UAVCAN_CPP_VERSION=UAVCAN_CPP03', 'UAVCAN_NO_ASSERTIONS=1', 'UAVCAN_NULLPTR=nullptr']
DEFINES_ST = '-D%s'
...
DEST_CPU = 'arm'
DEST_OS = 'linux'
DSDL_COMPILER = '/home/pc/hoijo_Poongsan/modules/uavcan/libuavcan/dsdl_compiler/libuavcan_dsdlc'
DSDL_COMPILER_DIR = '/home/pc/hoijo_Poongsan/modules/uavcan/libuavcan/dsdl_compiler'
ENABLE_GCCDEPS = ['c', 'cxx']
ENABLE_HEADER_CHECKS = False
GIT = ['/usr/bin/git']
GIT_SUBMODULES = ['PX4Firmware', 'PX4NuttX', 'uavcan', 'mavlink']
HAS_GTEST = False
INCLUDES = ['/home/pc/hoijo_Poongsan/libraries/', '/home/pc/hoijo_Poongsan/libraries/AP_Common/missing', '/home/pc/hoijo_Poongsan/modules/uavcan/libuavcan/include']
LIBDIR = '/usr/lib'
LIBPATH_ST = '-L%s'
LIB_ST = '-l%s'
...
MAVGEN = '/home/pc/hoijo_Poongsan/modules/mavlink/pymavlink/tools/mavgen.py'
MAVLINK_DIR = '/home/pc/hoijo_Poongsan/modules/mavlink'
NINJA = ['/usr/bin/ninja']
PREFIX = '/usr'
PX4IO_ELF_DEST = 'px4-extra-files/px4io'
PX4_ADD_GIT_HASHES = '/home/pc/hoijo_Poongsan/Tools/scripts/add_git_hashes.py'
PX4_APM_ROOT = '/home/pc/hoijo_Poongsan'
PX4_BOARD_NAME = 'px4fmu-v3'
PX4_BOARD_RC = False
PX4_BOOTLOADER = '/../../../Tools/bootloaders/px4fmuv2_bl.bin'
PX4_BOOTLOADER_NAME = 'px4fmuv2_bl.bin'
PX4_CMAKE_VARS = {'PX4_NUTTX_ROMFS': '/home/pc/hoijo_Poongsan/build/px4-v3/px4-extra-files/ROMFS', 'EXTRA_CXX_FLAGS': '-Wno-error=double-promotion -Wno-error=reorder -DCMAKE_BUILD -DARDUPILOT_BUILD -I/home/pc/hoijo_Poongsan/build/px4-v3/libraries/GCS_MAVLink -I/home/pc/hoijo_Poongsan/build/px4-v3/libraries/GCS_MAVLink/include/mavlink -Wl,--gc-sections', 'CONFIG': 'nuttx_px4fmu-v3_apm', 'CMAKE_MODULE_PATH': '/home/pc/hoijo_Poongsan/Tools/ardupilotwaf/px4/cmake', 'EXTRA_C_FLAGS': '-DCMAKE_BUILD', 'NUTTX_SRC': '/home/pc/hoijo_Poongsan/modules/PX4NuttX', 'ARDUPILOT_BUILD': 'YES'}
PX4_NUTTX_ROOT = '/home/pc/hoijo_Poongsan/modules/PX4NuttX'
...
PX4_ROOT = '/home/pc/hoijo_Poongsan/modules/PX4Firmware'
PYC = 1
PYFLAGS = ''
PYFLAGS_OPT = '-O'
PYO = 1
...
cfg_files = ['/home/pc/hoijo_Poongsan/build/px4-v3/ap_config.h']
cprogram_PATTERN = '%s'
